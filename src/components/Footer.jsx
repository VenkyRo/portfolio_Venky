...
const Footer = () => {
  return (
    <footer className="footer">
      ...
      <div className="icons-socailmdeia">
        <div class="social-links">
          <div id="twitter" class="social-btn flex-center">
            ...
            <span>
              <a id="links" href="https://x.com/sirisettyv18172" target="blank">
                @twitter
              </a>
            </span>
          </div>
          ...
          <div id="github" class="social-btn flex-center">
            ...
            <span>
              <a id="links" href="https://github.com/VenkyRo" target="blank">
                @github
              </a>
            </span>
          </div>
      ...
      <div className="footer-copyright">
        <p id="copy">
          &copy; 2024 Sirisetty Venkateswarlu. All rights reserved.
        </p>
      </div>
    </footer>
  );
